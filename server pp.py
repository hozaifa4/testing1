...
# Importing necessary libraries (বাকি কোড আগের মতোই থাকবে)
...
your_phone_number = os.environ.get('TELEGRAM_PHONE_NUMBER')

# --- 3. Source and Destination Channel IDs ---
# Set these as environment variables on your server.
source_channel_id_str = os.environ.get('SOURCE_CHANNEL_ID')
destination_channel_id_str = os.environ.get('DESTINATION_CHANNEL_ID')
